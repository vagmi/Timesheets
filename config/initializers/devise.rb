...
Devise.setup do |config|
  ...
  #config.omniauth :open_id, OpenID::Store::Filesystem.new('/tmp'), :domain => 'gmail.com'
  config.omniauth :google_apps, :store => OpenID::Store::Filesystem.new('/tmp'), :name => 'google', :identifier => 'https://www.google.com/accounts/o8/id', :require => 'omniauth-openid'
